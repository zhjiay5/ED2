...
module ed_max_dims
   ...
   !----- Maximum number DBH bins for windthrow mortality----------------------------------!
   integer, parameter :: ndbhmax=10   !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   ! 5 -- Forest regrowth.                                                                 !
   ! 6 -- Logged forest.                                                                   !
   ! 7 -- Hurricane tree fall.                                      !!! Jiaying Zhang      !
   !---------------------------------------------------------------------------------------!
   integer, parameter :: n_dist_types = 7                           !!! Jiaying Zhang
   !---------------------------------------------------------------------------------------!
