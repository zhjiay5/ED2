...
module ename_coms
   ...
   type ename_vars
      ...
      real                                              :: vmfact_c3
      real                                              :: vmfact_c4
      real                 , dimension(n_pft)           :: mphoto_trc3   !!!Jiaying
      real                                              :: mphoto_tec3
      real                                              :: mphoto_c4
      real                                              :: bphoto_blc3
      real                                              :: bphoto_nlc3
      ...
      real                                              :: kw_grass
      real                                              :: kw_tree
      real                 , dimension(n_pft)           :: gamma_c3      !!!Jiaying
      real                                              :: gamma_c4
      real                                              :: d0_grass
      real                                              :: d0_tree
      real                 , dimension(n_pft)           :: alpha_c3      !!!Jiaying
      real                                              :: alpha_c4
      real                                              :: klowco2in
      real                                              :: rrffact
      real                 , dimension(n_pft)           :: growthresp    !!!Jiaying
      real                                              :: lwidth_grass
      real                 , dimension(n_pft)           :: lwidth_bltree !!!Jiaying
      real                                              :: lwidth_nltree
      real                                              :: q10_c3
      real                                              :: q10_c4
      real                                              :: thetacrit
      ...
      !----- Variables that control Hurricane disturbances -----------------------------!
      integer                                           :: hurricane_ndbhclass        !!!Jiaying
      real                                              :: hurricane_wind_threshold   !!!Jiaying
      real                                              :: hurricane_distrate_a       !!!jiaying
      real                                              :: hurricane_distrate_b       !!!jiaying
      real            , dimension(ndbhmax*n_pft)        :: hurricane_s_a              !!!jiaying
      real            , dimension(ndbhmax*n_pft)        :: hurricane_s_b              !!!jiaying
      real            , dimension(ndbhmax+1)            :: hurricane_dbh_class        !!!Jiaying
      real                                              :: hurricane_defoliaterate    !!!Jiaying
      !----- Variables that are read from namelist with 18 PFT values ------------------!
      real            , dimension(n_pft)                :: Vm0IN                     !!!Jiaying
      real            , dimension(n_pft)                :: SLAIN                     !!!Jiaying
      real            , dimension(n_pft)                :: LTRIN                     !!!Jiaying
      real            , dimension(n_pft)                :: FRAIN                     !!!Jiaying
      real            , dimension(n_pft)                :: IDeIN                     !!!Jiaying
      real            , dimension(n_pft)                :: IDDIN                     !!!Jiaying
      real            , dimension(n_pft)                :: WDeIN                     !!!Jiaying
      real            , dimension(n_pft)                :: SbfIN                     !!!Jiaying
      real            , dimension(n_pft)                :: b1HtIN                    !!!Jiaying
      real            , dimension(n_pft)                :: b2HtIN                    !!!Jiaying
      real            , dimension(n_pft)                :: hgtmnIN                   !!!Jiaying
      real            , dimension(n_pft)                :: dbhADIN                   !!!Jiaying 
      real            , dimension(n_pft)                :: b1BlsIN                   !!!Jiaying
      real            , dimension(n_pft)                :: b1BllIN                   !!!Jiaying
      real            , dimension(n_pft)                :: b2BlsIN                   !!!Jiaying
      real            , dimension(n_pft)                :: b2BllIN                   !!!Jiaying
      real            , dimension(n_pft)                :: bleafADIN                 !!!Jiaying 
      real            , dimension(n_pft)                :: b1BssIN                   !!!Jiaying
      real            , dimension(n_pft)                :: b1BslIN                   !!!Jiaying
      real            , dimension(n_pft)                :: b2BssIN                   !!!Jiaying
      real            , dimension(n_pft)                :: b2BslIN                   !!!Jiaying
   ...
   subroutine init_ename_vars(enl)
      ...
      enl%hurricane_wind_threshold  = undef_real                           !!!Jiaying
      enl%hurricane_ndbhclass       = undef_integer                        !!!Jiaying
      enl%hurricane_dbh_class       = (/(undef_real,i=1,ndbhmax+1)/)       !!!Jiaying
      enl%hurricane_s_a             = (/(undef_real,i=1,ndbhmax*n_pft)/)   !!!Jiaying
      enl%hurricane_s_b             = (/(undef_real,i=1,ndbhmax*n_pft)/)   !!!Jiaying
      enl%hurricane_distrate_a      = undef_real                           !!!Jiaying
      enl%hurricane_distrate_b      = undef_real                           !!!Jiaying
      enl%hurricane_defoliaterate   = undef_real                           !!!Jiaying

      enl%Vm0IN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%SLAIN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%LTRIN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%FRAIN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%IDeIN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%IDDIN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%WDeIN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%SbfIN        = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
      enl%b1HtIN       = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b2HtIN       = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%hgtmnIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%dbhADIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b1BlsIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b1BllIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b2BlsIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b2BllIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%bleafADIN    = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b1BssIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b1BslIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b2BssIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying 
      enl%b2BslIN      = (/(undef_real,i=1,n_pft)/)                 !!!Jiaying
