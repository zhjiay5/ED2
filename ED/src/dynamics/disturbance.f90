...
module disturbance_utils
            ...
            new_lu_l1st: do new_lu = 1, n_dist_types
               ...
               old_lu_l1st: do ipa=1,onsp
                  ...
                  case (7)								     !!!Jiaying Zhang
                     !----- Hurriane disturbance. -----------------------------------------! !!!Jiaying Zhang
                     biomass_harvest = .false.
                     disturbed       = old_lu /= 1 .and. old_lu /= 2
                     !---------------------------------------------------------------------!
   ...
   subroutine site_disturbance_rates(year, cgrid)
      ...
      real                                       :: hurricane_disturbance_rate   !!!Jiaying Zhang
      logical                                    :: is_plantation
      !----- Local constants. -------------------------------------------------------------!
      ...
      polyloop: do ipy = 1,cgrid%npolygons
         ...
         siteloop: do isi = 1,cpoly%nsites
            ...
            !------------------------------------------------------------------------------!
            !    Calculate hurricane disturbance rates                  !!!Jiaying Zhang   !   
            !------------------------------------------------------------------------------!
            hurricane_disturbance_rate = sum(cpoly%lambda_hurricane(1:12,isi))      !!!Jiaying Zhang
            !------------------------------------------------------------------------------!
            ...
            cpoly%disturbance_rates(7,2,isi) = hurricane_disturbance_rate                !!!Jiaying Zhang
            !------------------------------------------------------------------------------!
            ...
            !------------------------------------------------------------------------------!
            cpoly%disturbance_rates(3,3:7,isi) = treefall_disturbance_rate           !!!Jiaying Zhang
            !------------------------------------------------------------------------------!
            ...
            ! lands may suffer this disturbance.                                           !
            !------------------------------------------------------------------------------!
            cpoly%disturbance_rates(4,3:7,isi) = fire_disturbance_rate             !!!Jiaying Zhang
            !------------------------------------------------------------------------------!


            !------------------------------------------------------------------------------! !!!Jiaying Zhang
            !      Disturbance that creates new "hurricane patches".  Only non-cultivated  ! !!!Jiaying Zhang
            ! lands may suffer this disturbance.                                           ! !!!Jiaying Zhang
            !------------------------------------------------------------------------------! !!!Jiaying Zhang
            cpoly%disturbance_rates(7,3:7,isi) = hurricane_disturbance_rate                  !!!Jiaying Zhang
            !------------------------------------------------------------------------------!
