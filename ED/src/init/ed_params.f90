...
subroutine load_ed_ecosystem_params()
   ...
   !   17 | Liana                                      |      no |      yes |           no !
   !   18 | Palm (Prestoea Montana)                    |      no |      yes |           no !
   !------+--------------------------------------------+---------+----------+--------------!
   ...
   is_tropical(14:18) = .true.  !!!Jiaying
   !---------------------------------------------------------------------------------------!
...
subroutine init_can_rad_params()
   ...
   clumping_factor(18)    = dble(clump_tree ) !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   orient_factor(   18) = dble(orient_tree) !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   leaf_emiss_tir(18)    = 9.50d-1  !!!Jiaying
   !----- Branches. -----------------------------------------------------------------------!
   ...
   wood_emiss_tir(18)    = 9.00d-1 !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   leaf_reflect_vis(18)    = dble(lreflect_vis) !!!Jiaying
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   leaf_reflect_nir(18)    = dble(lreflect_nir) !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   wood_reflect_vis(18)    = 1.10d-1  ! 1.60d-1   !!!Jiaying
   !----- Near infrared. ------------------------------------------------------------------!
   wood_reflect_nir(1:18)   = 2.50d-1  ! 5.30d-1  !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   leaf_trans_vis(   18) = dble(ltrans_vis)  !!!Jiaying
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   leaf_trans_nir(   18) = dble(ltrans_nir)  !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   wood_trans_vis(   18) = 1.00d-3 !!!Jiaying
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   wood_trans_nir(   18) = 1.00d-3 !!!Jiaying
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_photo_params()
   ...
   D0(16)                    = d0_grass
   D0(17)                    = d0_tree
   D0(18)                    = d0_tree  !!!Jiaying

   Vm_low_temp(1:4)          =  5.0             ! c4 grass   !!! Jiaying
   ...
   Vm_low_temp(18)           =  5.0             ! Palm     !!!Jiaying

   Vm_high_temp(1:18)        =  45.0            !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   !---------------------------------------------------------------------------------------!
   Vm_decay_e(1:18)          = 0.4     !          !!!Jiaying                      [    ---]
   Vm_decay_a(1:18)          = 220000. !          !!!Jiaying                      [  J/mol]
   Vm_decay_b(1:18)          = 690.    !          !!!Jiaying                      [J/mol/K]
   !---------------------------------------------------------------------------------------!
   ...
   !Vm0(2)               = 18.750000 * ssfact * vmfact_c3 !!!Jiaying
   !Vm0(3)               = 12.500000 * ssfact * vmfact_c3 !!!Jiaying
   !Vm0(4)               =  6.250000 * ssfact * vmfact_c3 !!!Jiaying
   ...
   !Vm0(18)              = Vm0(4)  !!!Jiaying??CHECK?????????
   !---------------------------------------------------------------------------------------!
   Vm0(1:18) = Vm0IN(1:18)  ! !!!Jiaying
   ...
   !dark_respiration_factor(2)     = gamma_c3     !!! Jiaying
   !dark_respiration_factor(3)     = gamma_c3     !!! Jiaying
   !dark_respiration_factor(4)     = gamma_c3     !!! Jiaying
   ...
   !dark_respiration_factor(18)    = gamma_c3     !!!Jiaying
   !---------------------------------------------------------------------------------------!
   dark_respiration_factor(1:18) = gamma_c3(1:18)    !!!Jiaying

   !----- Currently we assume most parameters to be the same as the Vm ones. --------------!
   Rd_low_temp (1:18) = Vm_low_temp (1:18)
   Rd_high_temp(1:18) = Vm_high_temp(1:18)
   Rd_decay_e  (1:18) = Vm_decay_e  (1:18)
   Rd_hor      (1:18) = Vm_hor      (1:18)
   Rd_q10      (1:18) = Vm_q10      (1:18)
   ...
   stomatal_slope(2)         = mphoto_trc3(2)   !!! Jiaying
   stomatal_slope(3)         = mphoto_trc3(3)   !!! Jiaying
   stomatal_slope(4)         = mphoto_trc3(4)   !!! Jiaying
   stomatal_slope(5)         = mphoto_trc3(5)
   ...
   stomatal_slope(12)        = mphoto_trc3(12)
   stomatal_slope(13)        = mphoto_trc3(13)
   stomatal_slope(14)        = mphoto_c4
   stomatal_slope(15)        = mphoto_c4
   stomatal_slope(16)        = mphoto_trc3(16)
   stomatal_slope(17)        = mphoto_trc3(17)
   stomatal_slope(18)        = mphoto_trc3(18)   !!! Jiaying
   ...
   cuticular_cond(18)        = bphoto_blc3

   quantum_efficiency(1)     = alpha_c4
   quantum_efficiency(2)     = alpha_c3(2)
   quantum_efficiency(3)     = alpha_c3(3)   !!! Jiaying
   quantum_efficiency(4)     = alpha_c3(4)   !!! Jiaying
   quantum_efficiency(5)     = alpha_c3(5)
   quantum_efficiency(6)     = alpha_c3(6)
   quantum_efficiency(7)     = alpha_c3(7)
   quantum_efficiency(8)     = alpha_c3(8)
   quantum_efficiency(9)     = alpha_c3(9)
   quantum_efficiency(10)    = alpha_c3(10)
   quantum_efficiency(11)    = alpha_c3(11)
   quantum_efficiency(12)    = alpha_c3(12)
   quantum_efficiency(13)    = alpha_c3(13)
   quantum_efficiency(14)    = alpha_c4
   quantum_efficiency(15)    = alpha_c4
   quantum_efficiency(16)    = alpha_c3(16)
   quantum_efficiency(17)    = alpha_c3(17)
   quantum_efficiency(18)    = alpha_c3(18)   !!! Jiaying
   ...
   water_conductance(18)     = kw_tree  / yr_sec !!!jiaying
   !---------------------------------------------------------------------------------------!
   ...
   photosyn_pathway(16:18)   = 3

   !----- Leaf width [m].  This controls the boundary layer conductance. ------------------!
   leaf_width( 1)    = lwidth_grass
   leaf_width( 2)    = lwidth_bltree(2)   !!! Jiaying
   leaf_width( 3)    = lwidth_bltree(3)   !!! Jiaying
   leaf_width( 4)    = lwidth_bltree(4)   !!! Jiaying
   leaf_width( 5)    = lwidth_grass
   leaf_width( 6)    = lwidth_nltree
   leaf_width( 7)    = lwidth_nltree
   leaf_width( 8)    = lwidth_nltree
   leaf_width( 9)    = lwidth_bltree(9)
   leaf_width(10)    = lwidth_bltree(10)
   leaf_width(11)    = lwidth_bltree(11)
   ...
   leaf_width(17)    = lwidth_bltree(17)
   leaf_width(18)    = lwidth_bltree(18)   !!! Jiaying
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_resp_params()
   ...
   !growth_resp_factor(2)          = growthresp   !!!Jiaying
   !growth_resp_factor(3)          = growthresp   !!!Jiaying
   !growth_resp_factor(4)          = growthresp   !!!Jiaying
   ...
   !growth_resp_factor(18)         = growthresp   !!!Jiaying
   growth_resp_factor(1:18)  = growthresp(1:18)    !!!Jiaying

   !leaf_turnover_rate(1)          = 2.0
   !leaf_turnover_rate(2)          = 1.0   !!! Jiaying
   !leaf_turnover_rate(3)          = 0.5   !!! Jiaying
   ...
   !leaf_turnover_rate(18)         = onethird  !!!Jiaying
   leaf_turnover_rate(1:18) = LTRIN(1:18)
   ...
   storage_turnover_rate(18)      = onesixth
   ...
   select case (iphysiol)
      case (0,1)
         !----- Arrhenius function. ----------------------------------------------------------!
         root_respiration_factor(1:18)   = 0.528 * rrffact
      case (2,3)
         !----- Collatz function. ------------------------------------------------------------!
         root_respiration_factor(1:18)   = 0.280 * rrffact
   end select
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_mort_params()
   ...
   mort3(2)  = m3_scale * ( m3_slope * (1. - rho( 2) / rho( 4)) ) ! 0.07235222 !!!jiaying
   mort3(3)  = m3_scale * ( m3_slope * (1. - rho( 3) / rho( 4)) ) ! 0.04156404 !!!jiaying
   mort3(4)  = m3_scale * ( m3_slope * (1. - rho( 4) / rho( 4)) ) ! 0.0!check !!!jiaying
   mort3(5)  = 0.066
   mort3(6)  = 0.0033928
   mort3(7)  = 0.0043
   mort3(8)  = 0.0023568
   ...
   mort3(18) = 0.0 ! m3_scale * ( m3_slope * (1. - rho( 18) / rho( 4)) ) !  !!!jiaying
   !---------------------------------------------------------------------------------------!
   ...
   cbr_severe_stress(1:18) = log(epsilon(1.0)) / mort2(1:18)
   !---------------------------------------------------------------------------------------!
   ...
   select case (ibigleaf)
      case (0)
         ...
         seedling_mortality(18)   = 0.95  ! 0.82 !!!Jiaying from USDA document
      case (1)
         select case (iallom)
            case (0,1)
               ...
               seedling_mortality(18)    = onethird 
            case default
               seedling_mortality(1)     = 0.9500
   ...
   treefall_s_gtht(18)      = 0.00  !!!Jiaying
   ...
   treefall_s_ltht(18)      = 0.10 !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   fire_s_gtht(1:18)    = 0.0
   !----- Trees shorter than fire_hite_threshold. -----------------------------------------!
   fire_s_ltht(1:18)       = 0.0
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_alloc_params()
   ...
   use pft_coms     , only : leaf_turnover_rate    & ! intent(in)
      ...
      , init_density_decay_factor  & ! intent(out) !!!Jiaying
   ...
   use physiology_coms, only : SLAIN    & ! intent(in)   !!!Jiaying
      , b1HtIN                  & ! intent(in)   !!!Jiaying 
      , b2HtIN                  & ! intent(in)   !!!Jiaying 
      , hgtmnIN                 & ! intent(in)   !!!Jiaying 
      , dbhADIN                 & ! intent(in)   !!!Jiaying 
      , b1BlsIN                 & ! intent(in)   !!!Jiaying 
      , b1BllIN                 & ! intent(in)   !!!Jiaying 
      , b2BlsIN                 & ! intent(in)   !!!Jiaying 
      , b2BllIN                 & ! intent(in)   !!!Jiaying 
      , bleafADIN               & ! intent(in)   !!!Jiaying 
      , b1BssIN                 & ! intent(in)   !!!Jiaying 
      , b1BslIN                 & ! intent(in)   !!!Jiaying 
      , b2BssIN                 & ! intent(in)   !!!Jiaying 
      , b2BslIN                 & ! intent(in)   !!!Jiaying 
      , WDeIN                   & ! intent(in)   !!!Jiaying 
      , FRAIN                   & ! intent(in)   !!!Jiaying
      , IDeIN                   & ! intent(in)   !!!Jiaying 
      , IDDIN                   ! ! intent(in)   !!!Jiaying 
   ...
   !rho(18)    = 0.90   !!! Jiaying !!!CHECK!!!
   !---------------------------------------------------------------------------------------!
   rho(1:18) = WDeIN(1:18)  !!!Jiaying
   ...
   !SLA( 2) = 10.0**(sla_inter + sla_slope * log10(12.0/leaf_turnover_rate(2))) * sla_scale   !!! Jiaying
   !SLA( 3) = 10.0**(sla_inter + sla_slope * log10(12.0/leaf_turnover_rate(3))) * sla_scale   !!! Jiaying
   !SLA( 4) = 10.0**(sla_inter + sla_slope * log10(12.0/leaf_turnover_rate(4))) * sla_scale   !!! Jiaying
   !SLA( 5) = 22.0
   !SLA( 6) =  6.0
   !SLA( 7) =  9.0
   !SLA( 8) = 10.0
   ...
   !SLA(18) = 10.0**(sla_inter + sla_slope * log10(12.0/leaf_turnover_rate( 18))) * sla_scale   !!! Jiaying
   SLA(1:18) = SLAIN(1:18)  !!!Jiaying
   ...
   horiz_branch(18)    = 0.61 ! 0.40 !!!Jiaying !!!CHECK!!!
   !---------------------------------------------------------------------------------------!
   ...
   !q(16)    = 1.0
   !q(17)    = 1.0
   !q(18)    = 1.0 !!!Jiaying !!CHECK!!!
   q(1:18) = FRAIN(1:18)  !!!Jiaying


   sapwood_ratio(1:18) = 3900.0
   ...
   qsw(18)     = SLA(18)    / sapwood_ratio(18)
   !---------------------------------------------------------------------------------------!
   ...
   !---------------------------------------------------------------------------------------!
   SRA(1:18)   = 24. * 2. ! m2/kgC --> this is from Amazon  !!!CHECK Jiaying
   ...
   !init_density(18)    = 0.1
   !---------------------------------------------------------------------------------------!
   init_density(1:18) = IDeIN(1:18)               !!!Jiaying
   init_density_decay_factor(1:18) = IDDIN(1:18)  !!!Jiaying
   ...
   select case (iallom)
      case (0:1)
        ...
        !    end if
        ! end do
	 b1Ht(1:18) = b1HtIN(1:18);  !!! Jiaying
	 b2Ht(1:18) = b2HtIn(1:18);  !!! Jiaying
      ...
      case default
         ...
         do ipft=1,n_pft
            if (is_tropical(ipft)) then
               ...
               b1Ht   (ipft) = 0.0352 ! 0.056   !!! Jiaying
               b2Ht   (ipft) = 0.694  ! 0.709   !!! Jiaying
               !----- hgt_ref is their "Hmax". -----------------------------------------------!
               hgt_ref(ipft) = 61.7 ! 40.0   !!! Jiaying
            end if
         end do

      !   !------------------------------------------------------------------------------------!
      !   ! Use allometric equation calculated from Bisley census data          !!!Jiaying     !
      !   !------------------------------------------------------------------------------------!
      !   b1Ht( 2) = 0.0291
      !   b1Ht( 3) = 0.0562
      !   b1Ht( 4) = 0.0507
   ...
   hgt_min(14)    = 0.50
   hgt_min(15)    = 0.50
   hgt_min(16)    = 1.50  !!!Jiaying
   hgt_min(17)    = 0.50
   hgt_min(18)    = 1.50  !!!Jiaying
   !----- Maximum Height. -----------------------------------------------------------------!
   hgt_max( 1) = 1.50
   hgt_max( 2) = 35.0
   hgt_max( 3) = 35.0
   ...
   hgt_max(14) = 1.50
   hgt_max(15) = 1.50
   hgt_max(16) = 5.5 ! 1.50 !!! Jiaying
   hgt_max(17) = 35.0
   hgt_max(18) = 35 ! 20.0 !!!Jiaying
   !---------------------------------------------------------------------------------------!

  !-----------------------------------------
  ! H>=1.5m & DBH>=2.5cm(EML) or 8cm(P)   !!!Jiaying
  ! Corresponds to:
  ! DBH_min(2:4) = 2.5 cm
  ! DBH_min( 18) = 5.4 cm
  !-----------------------------------------
  ...
  ! hgt_min(3)     = 3.7241  
  ! hgt_min(4)     = 3.5868  
  ! hgt_min(18)    = 3.148 ! 2.875  
  hgt_min(1:18)  = hgtmnIN(1:18)   
   ...
   dbh_adult  (1:18) = dbhADIN(1:18) !38 ! 13.0   !!!Jiaying
   !---------------------------------------------------------------------------------------!
   ...
   select case (iallom)
      ...
      case default
         ...
         dbh_bigleaf(17) = 30.0
         dbh_bigleaf(18) = 16.67251 !!!Jiaying
   end select
   !---------------------------------------------------------------------------------------!
   ...
   !----------------------------------------------------------!
   ! bxBl: CECSCH/OCOLEU/SLOBER -> E/M/L           !!!Jiaying
   ! reference: Scatena et al. 1993
   !----------------------------------------------------------!
    b1Bl_small( 2) = 0.061
    b1Bl_small( 3) = 0.0294
    b1Bl_small( 4) = 0.0844
    b1Bl_small(18) = 0.061 ! 0.3084

    b2Bl_small( 2) = 1.449
    b2Bl_small( 3) = 1.808
    b2Bl_small( 4) = 1.916
    b2Bl_small(18) = 1.449 ! 1.662
    ...
    b1Bl_small(1:18)=b1BlsIN(1:18)
    b2Bl_small(1:18)=b2BlsIN(1:18)
    b1Bl_large(1:18)=b1BllIN(1:18)
    b2Bl_large(1:18)=b2BllIN(1:18)
    bleaf_adult(1:18)=bleafADIN(1:18)
   !----------------------------------------------------------!
   ! The following block is commented out by Jiaying          !
   !----------------------------------------------------------!
   ...
   !----------------------------------------------------------!
   ! bxBs: CECSCH/OCOLEU/SLOBER -> E/M/L           !!!Jiaying
   ! reference: Scatena et al. 1993
   !----------------------------------------------------------!
    b1Bs_small( 2) = 0.0866
    b1Bs_small( 3) = 0.0966
    b1Bs_small( 4) = 0.1808
    b1Bs_small(18) = 0.0866 ! 1.0705

    b2Bs_small( 2) = 2.543
    b2Bs_small( 3) = 2.500
    b2Bs_small( 4) = 2.501
    b2Bs_small(18) = 2.543 ! 1.662

    b1Bs_large (:) = b1Bs_small (:) 
    b2Bs_large (:) = b2Bs_small (:) 


    b1Bs_small(1:18)=b1BssIN(1:18)
    b2Bs_small(1:18)=b2BssIN(1:18)
    b1Bs_large(1:18)=b1BslIN(1:18)
    b2Bs_large(1:18)=b2BslIN(1:18)
   ...
   if (ibigleaf == 1 .and. (iallom == 0 .or. iallom == 1)) then
      ...
      b1Bl_small(   18)  = 0.08915847  !!! Jiaying
      ...
      b2Bl_small(   18)  = 1.663773  !!! Jiaying
      ...
      b1Bs_small(   18)  = 0.26890751   !!! Jiaying
      ...
      b2Bs_small(   18)  = 2.254336   !!! Jiaying
   ...
   b1Ca(5:13)  = 2.490154
   b1Ca(14:18) = exp(-1.853) * exp(b1Ht(14:18)) ** 1.888
   !----- Slope.  -------------------------------------------------------------------------!
   b2Ca(1:4)   = b2Ht(1:4) * 1.888
   b2Ca(5:13)  = 0.8068806
   b2Ca(14:18) = b2Ht(14:18) * 1.888
      ...
      case (0,1)
         ...
         do ipft=1,n_pft
            if (is_tropical(ipft)) then
               ...
               b1Ca(ipft) = 0.7832 !  !!!Jiaying
               b2Ca(ipft) = 1.2083 !  !!!Jiaying
            end if
         end do
      case default
   ...
   b1WAI(18)    = 0.0192 * 0.5 ! !!!Jiaying !!CHECK
   !----- Slope. --------------------------------------------------------------------------!
   ...
   ! Commented out by Jiaying, because it has already been assigned in lines xxx  !!!Jiaying
   !---------------------------------------------------------------------------------------!
   !    Initial density of plants, for near-bare-ground simulations [# of individuals/m2]  !
   !---------------------------------------------------------------------------------------!
   ! select case (ibigleaf)
...
subroutine init_pft_nitro_params()
   ...
   c2n_leaf(16:18)  = 1000.0 / ((0.11289 + 0.12947 * Vm0(16:18)) * SLA(16:18))!23.5
...
subroutine init_pft_leaf_params()
   ...
   !---------------------------------------------------------------------------------------!
   c_grn_leaf_dry     (1:18) = 3218.0    ! Jones 1992  J/(kg K)
   wat_dry_ratio_ngrn (1:18) = 0.7       ! Forest Products Laboratory (2010)
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_repro_params()
   ...
   use physiology_coms, only :  SbfIN      ! ! intent(in)   !!!Jiaying
   ...
   !r_fract(16)             = 0.3
   !r_fract(17:18)          = 0.3  
   r_fract(1:18) = SbfIN(1:18)   !!!Jiaying
   ...
   nonlocal_dispersal(18)  =  1.000 ! 0.600
   ...
   repro_min_h(16)         =  0.0
   repro_min_h(17)         = 18.0
   repro_min_h(18)         = 18.0 ! 6.0 ! !!!Jiaying CHECK
...
subroutine init_rk4_params()
   ...
   effarea_transp(17:18)= 1.d0 ! Hypostomatous
   !---------------------------------------------------------------------------------------!
